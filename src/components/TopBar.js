  ...
  return (
    <>
      {/* <div className="px-3 py-5 w-full "> */}
        <div className="flex justify-between items-center sticky  h-20 px-3 py-5 w-full top-0 z-2 bg-white">
          <div>
            <button
              className="top_bar_btn flex items-center border rounded-full justify-center gap-2 py-3"
          ...
          <div className="flex items-center gap-5">
            <button
              className="top_bar_btn2 flex items-center border rounded-full justify-center gap-2 py-3"
              style={{ borderColor: colors.primary_purp[100] }}
            >
            ...
            <div className="relative">
              <input
                type="text"
                style={{ backgroundColor: colors.input_bg[100] }}
                className="topbar_inpt p-2 "
              />
